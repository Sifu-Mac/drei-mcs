...
Fork-Basis von ClawDeck für ein eigenes Mission-Control-System auf:

- Subdomain: `mission.digitalbackup.cloud`
- Stack: Rails + PostgreSQL + Docker + Traefik
- Workflow: Sifu / James / Codex

## Aktueller Stand

- Upstream ClawDeck als Basis importiert
- Gap-Analyse vorhanden unter `docs/planning/MCS_GAP_ANALYSIS.md`
- Docker-/Traefik-Deployment für `mission.digitalbackup.cloud` vorbereitet
...
Die App ist noch nicht fachlich komplett zu MCS umgebaut. Das hier ist die lauffähige technische Basis für MCS v1.
